...
public class MainFrame extends JFrame {
    ...
    private void addRadioButton(String name, final int formula_number)
    {
        ...
        button.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent actionEvent)
            {
                ...
                if (formula_number == 1)	image.setIcon(new ImageIcon(MainFrame1.class.getResource("formula_1.png")));
                if (formula_number == 2) image.setIcon(new ImageIcon(MainFrame1.class.getResource("formula_2.png")));
            }
        });
    ...
    public MainFrame() {
        ...
        result_field = new JTextField("0",10);
        ...
        JTextField mem = new JTextField("0",10);
        memory_result.add(MC);
        memory_result.add(Box.createHorizontalStrut(10));
        memory_result.add(mem);
        mem.setMaximumSize(result_field.getPreferredSize());
        memory_result.add(Box.createHorizontalStrut(10));
